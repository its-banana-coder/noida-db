...
const SCRIPTS: &[((u32, u32), &[&str])] = &[
    ...
    (
        ...
        &[
            ...
            "BITCOUNT s 2 1",
            "BITCOUNT s -1 -2",
            "@7.0 BITCOUNT s 0 0 BIT",
            "@7.0 BITCOUNT s 5 30 BIT",
            "@7.0 BITCOUNT s 0 -5 BIT",
            "@7.0 BITCOUNT s 26 -1 BIT",
            "@7.0 BITCOUNT s 0 0 FOO",
            "BITCOUNT nokey",
            "BITCOUNT nokey 0 1",
            "BITCOUNT s 0",
            "LPUSH l x",
    ...
    (
        ...
        &[
            ...
            "BITPOS s 1 0 -1",
            "BITPOS s 0 2 -1",
            "@7.0 BITPOS s 1 2 -1 BIT",
            "@7.0 BITPOS s 0 0 -1 BIT",
            "BITPOS s 1 100",
            "@7.0 BITPOS s 1 0 0 FOO",
            "BITPOS s 2",
            "BITPOS nokey 1",
            "BITPOS nokey 0",
            "SET z \\x00\\x00",
    ...
    (
        ...
        &[
            ...
            "GET dst",
            "BITOP NOT dst a b",
            "BITOP AND dst nokey nokey2",
            "EXISTS dst",
            "BITOP AND dst a nokey",
            "GET dst",
            "BITOP FOO dst a",
            "LPUSH l x",
            "BITOP AND dst a l",
    ...
    (
        (3, 2),
        &[
            "BITFIELD bf SET u8 0 255 GET u8 0",
            "BITFIELD bf INCRBY u8 0 10 GET u8 0",
            "BITFIELD bf OVERFLOW SAT INCRBY u8 0 250 GET u8 0",
            "BITFIELD bf OVERFLOW FAIL INCRBY u8 0 250",
            "BITFIELD bf OVERFLOW WRAP INCRBY u8 0 250 GET u8 0",
            "BITFIELD bf SET i8 0 -128 GET i8 0",
            "BITFIELD bf OVERFLOW SAT INCRBY i8 0 -100 GET i8 0",
            "BITFIELD bf OVERFLOW WRAP INCRBY i8 0 -100 GET i8 0",
            "BITFIELD bf SET i64 64 -9223372036854775808 GET i64 64",
            "BITFIELD bf OVERFLOW SAT INCRBY i64 64 -1 GET i64 64",
            "BITFIELD bf SET u63 128 9223372036854775807 GET u63 128",
            "BITFIELD bf INCRBY u63 128 1",
            "BITFIELD bf GET u8 #0 GET u8 #1",
            "BITFIELD bf SET u8 #2 7 GET u8 16",
            "STRLEN bf",
            "BITFIELD bf GET u64 0",
            "BITFIELD bf GET i65 0",
            "BITFIELD bf GET u0 0",
            "BITFIELD bf GET x8 0",
            "BITFIELD bf OVERFLOW BAD INCRBY u8 0 1",
            "BITFIELD bf FOO u8 0",
            "BITFIELD bf GET u8",
            "BITFIELD bf SET u8 0",
            "BITFIELD bf",
            "BITFIELD nokey GET u8 0",
            "EXISTS nokey",
            "BITFIELD nokey2 SET u8 0 1",
            "EXISTS nokey2",
    ...
    (
        ...
        &[
            ...
            "ZSCORE Sicily Catania",
            "ZRANGE Sicily 0 -1 WITHSCORES",
            "GEOADD Sicily 13.361389 38.115556 Palermo",
            "@6.2 GEOADD Sicily CH 13.5 38.2 Palermo",
            "@6.2 GEOADD Sicily NX 13.361389 38.115556 Palermo",
            "@6.2 GEOADD Sicily XX CH 13.361389 38.115556 Palermo",
            "@6.2 GEOADD Sicily XX 1 2 nosuchmember",
            "@6.2 GEOADD Sicily NX XX 1 2 m",
            "GEOADD Sicily 1 2",
            "GEOADD Sicily 181 38 bad",
            "GEOADD Sicily 13 90 bad",
            "GEOADD Sicily x 38 bad",
            "GEOPOS Sicily Palermo Catania nosuch",
            "GEOPOS nokey Palermo",
            "GEODIST Sicily Palermo Catania",
            "GEODIST Sicily Palermo Catania km",
            "@6.2 GEODIST Sicily Palermo Catania KM",
            "GEODIST Sicily Palermo Catania mi",
            "GEODIST Sicily Palermo Catania ft",
            "GEODIST Sicily Palermo nosuch",
            "GEODIST nokey a b",
            "@7.0 GEODIST Sicily Palermo Catania yards",
            "GEODIST Sicily Palermo Catania km extra",
            "GEOHASH Sicily Palermo Catania nosuch",
            "GEOHASH nokey Palermo",
            "SET str v",
            "GEOADD str 1 2 m",
            "GEOPOS str m",
            "GEODIST str a b",
    ...
    (
        ...
        &[
            ...
            "~GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km ASC",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km DESC",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km ASC COUNT 1",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km ASC WITHCOORD WITHDIST WITHHASH",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km ASC WITHDIST",
            "GEOSEARCH k FROMMEMBER Palermo BYRADIUS 200 km ASC WITHDIST",
            "GEOSEARCH k FROMMEMBER Palermo BYBOX 400 400 km ASC WITHDIST",
            "GEOSEARCH k FROMLONLAT 15 37 BYBOX 400 400 km ASC WITHCOORD",
            "GEOSEARCH k FROMLONLAT 15 37 BYBOX 1 1 m ASC",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 1 m ASC",
            "GEOSEARCH nokey FROMLONLAT 15 37 BYRADIUS 200 km ASC",
            "GEOSEARCH k FROMMEMBER nosuch BYRADIUS 200 km",
            "GEOSEARCH k BYRADIUS 200 km",
            "GEOSEARCH k FROMLONLAT 15 37",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS -1 km",
            "@7.0 GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 1 parsecs",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS x km",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km COUNT 0",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km ANY",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km FOO",
            "GEOSEARCH k FROMLONLAT 15 37 BYRADIUS 200 km FROMMEMBER Palermo",
            "GEOSEARCHSTORE dst k FROMLONLAT 15 37 BYRADIUS 200 km ASC",
            "ZRANGE dst 0 -1 WITHSCORES",
            "GEOSEARCHSTORE dst k FROMLONLAT 15 37 BYRADIUS 200 km ASC STOREDIST",
            "ZRANGE dst 0 -1 WITHSCORES",
            "GEOSEARCHSTORE dst k FROMLONLAT 15 37 BYRADIUS 1 m",
            "EXISTS dst",
            "GEOSEARCHSTORE dst nokey FROMLONLAT 15 37 BYRADIUS 200 km",
            "GEOSEARCHSTORE dst k FROMLONLAT 15 37 BYRADIUS 200 km WITHDIST",
        ],
    ),
    (
        (3, 2),
        &[
            ...
            "GEORADIUS k 15 37 200 km ASC",
            "GEORADIUS k 15 37 200 km ASC WITHDIST WITHCOORD WITHHASH",
            "GEORADIUS k 15 37 200 km ASC COUNT 1",
            "GEORADIUS k 15 37 1 m",
            "GEORADIUS nokey 15 37 200 km",
            "@7.0 GEORADIUS k 15 37 200 parsecs",
            "GEORADIUS k 15 37 -1 km",
            "GEORADIUS k 181 37 200 km",
            "GEORADIUSBYMEMBER k Palermo 200 km ASC",
            "GEORADIUSBYMEMBER k Palermo 200 km ASC WITHDIST",
            "GEORADIUSBYMEMBER k nosuch 200 km",
            "GEORADIUSBYMEMBER nokey m 200 km",
            "GEORADIUS k 15 37 200 km STORE dst",
            "ZRANGE dst 0 -1 WITHSCORES",
            "GEORADIUS k 15 37 200 km STOREDIST dst2",
            "@7.0 ZRANGE dst2 0 -1 WITHSCORES",
            "@7.0 GEORADIUS k 15 37 200 km STORE dst WITHDIST",
            "GEORADIUS_RO k 15 37 200 km ASC",
            "GEORADIUS_RO k 15 37 200 km STORE dst",
            "GEORADIUSBYMEMBER_RO k Palermo 200 km ASC",
            "GEORADIUSBYMEMBER_RO k Palermo 200 km STORE dst",
        ],
    ),
    (
        (3, 2),
        &[
            "GEOADD w 0 0 origin -180 -85.05112878 sw 179.999 85.05112878 ne",
            "GEOPOS w origin sw ne",
            "GEOHASH w origin sw ne",
            "ZSCORE w origin",
            "ZSCORE w sw",
            "GEODIST w origin sw",
            "GEODIST w sw ne km",
            "GEOADD w 0.000001 0.000001 tiny",
            "GEODIST w origin tiny",
            "@6.2 GEOSEARCH w FROMLONLAT 0 0 BYRADIUS 1 m ASC WITHDIST WITHCOORD",
        ],
    ),
];
