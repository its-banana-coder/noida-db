...
const SCRIPTS: &[((u32, u32), &[&str])] = &[
    ...
    (
        ...
        &[
            ...
            "XRANGE s - +",
            "XTRIM s MAXLEN -1",
            "XTRIM s MAXLEN 1 MINID 1",
            "XTRIM s",
            "XTRIM s LIMIT 5",
            "XTRIM s MAXLEN 1 LIMIT 5",
            "XTRIM nokey MAXLEN 1",
            "XADD s MAXLEN 1 5-1 e 5",
            "XLEN s",
            "XADD s MAXLEN 0 6-1 f 6",
            "XLEN s",
            "XADD s NOMKSTREAM 7-1 g 7",
    ...
    (
        ...
        &[
            ...
            "XREAD COUNT 1",
            "XREAD STREAMS s >",
            "XREAD GROUP g c STREAMS s 0",
            "XREAD NOACK STREAMS s 0",
            "XREAD BLOCK 0 COUNT 1 STREAMS s 0",
            "XREAD BLOCK 10 STREAMS s $",
            "XREAD BLOCK bad STREAMS s $",
            "SET str v",
            "XREAD STREAMS str 0",
            "!HELLO 3",
            "XREAD COUNT 10 STREAMS s 0",
    ...
    // A blocked XREAD is served by the next XADD, FIFO.
    (
        (5, 0),
        &[
            "XADD s 1-1 a 1",
            "&1 XREAD BLOCK 0 STREAMS s $",
            "&2 XREAD BLOCK 0 STREAMS s $",
            "XADD s 2-1 b 2",
            "<1",
            "<2",
            "&3 XREAD BLOCK 0 STREAMS new $",
            "XADD new 1-1 x 1",
            "<3",
            "&4 XREAD BLOCK 10 STREAMS s $",
            "<4",
        ],
    ),
    // ---- consumer groups ----
    (
        ...
        &[
            ...
            "TYPE s",
            "XGROUP CREATE s g 0",
            "XGROUP CREATE s other $",
            "XGROUP CREATECONSUMER s g alice",
            "XGROUP CREATECONSUMER s g alice",
            "XGROUP DELCONSUMER s g alice",
            "XGROUP DELCONSUMER s g nobody",
            "XGROUP CREATECONSUMER s nogroup alice",
            "XGROUP SETID s g 5-5",
            "XGROUP SETID s g 5-5 ENTRIESREAD 3",
            "XGROUP SETID s g 5-5 ENTRIESREAD -3",
            "XGROUP SETID s g bad",
            "XGROUP DESTROY s other",
            "XGROUP DESTROY s other",
            "XGROUP DESTROY nokey g",
            "XGROUP FOO s g",
            "XGROUP CREATE nokey g 0",
            "XINFO GROUPS s",
            "XINFO STREAM s",
            "XINFO STREAM nokey",
            "XINFO FOO s",
    ...
    (
        ...
        &[
            ...
            "XREADGROUP GROUP g carol STREAMS s 0",
            "XREADGROUP GROUP g carol STREAMS s >",
            "XREADGROUP GROUP g carol STREAMS s >",
            "XPENDING s g",
            "XACK s g 1-1 1-1 9-9",
            "XACK nokey g 1-1",
            "XACK s nogroup 1-1",
            "XPENDING s g",
            "XDEL s 2-1",
            "XREADGROUP GROUP g bob STREAMS s 0",
            "XADD s 4-1 d 4",
            "XREADGROUP GROUP g alice NOACK STREAMS s >",
            "XPENDING s g",
            "XREADGROUP GROUP nope alice STREAMS s >",
            "XREADGROUP GROUP g alice STREAMS s $",
            "XREADGROUP COUNT 1 STREAMS s >",
            "XREAD GROUP g alice STREAMS s 0",
            "XREAD NOACK STREAMS s 0",
            "XINFO GROUPS s",
            "!XINFO CONSUMERS s g",
            "XINFO CONSUMERS s nope",
            "XLEN s",
        ],
    ),
    (
        ...
        &[
            ...
            "XGROUP CREATE s g 0",
            "XREADGROUP GROUP g alice STREAMS s >",
            "XCLAIM s g bob 100000 1-1",
            "XCLAIM s g bob 0 1-1",
            "XCLAIM s g bob 0 9-9",
            "XCLAIM s g bob 0 2-1 JUSTID",
            "XCLAIM s g bob 0 3-1 RETRYCOUNT 7 JUSTID",
            "XCLAIM s g bob 0 bad",
            "XCLAIM s g bob bad 1-1",
            "XCLAIM s g bob 0 1-1 FOO",
            "XCLAIM s nogroup bob 0 1-1",
            "XCLAIM nokey g bob 0 1-1",
            "!XPENDING s g - + 10",
            "!XPENDING s g - + 10 bob",
            "!XPENDING s g - + 10 alice",
            "XPENDING s g",
            "XPENDING s g - +",
            "XPENDING nokey g",
            "XADD s 4-1 d 4",
            "XCLAIM s g carol 0 4-1 FORCE JUSTID",
            "XPENDING s g",
            "XAUTOCLAIM s g dave 0 0 COUNT 2 JUSTID",
            "XAUTOCLAIM s g dave 0 0 JUSTID",
            "XAUTOCLAIM s g dave 0 0 COUNT 0",
            "XAUTOCLAIM s g dave 0 bad",
            "XAUTOCLAIM s nogroup dave 0 0",
            "XDEL s 1-1",
            "XAUTOCLAIM s g erin 0 0 JUSTID",
            "XPENDING s g",
            "XGROUP DELCONSUMER s g erin",
            "XPENDING s g",
        ],
    ),
    // A blocked XREADGROUP is served by the next XADD.
    (
        (7, 0),
        &[
            "XADD s 1-1 a 1",
            "XGROUP CREATE s g $",
            "&1 XREADGROUP GROUP g alice BLOCK 0 STREAMS s >",
            "&2 XREADGROUP GROUP g bob BLOCK 0 STREAMS s >",
            "XADD s 2-1 b 2",
            "<1",
            "XADD s 3-1 c 3",
            "<2",
